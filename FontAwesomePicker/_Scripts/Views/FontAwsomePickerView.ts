module ProActive.SharePoint.IntraActive.Views {
    export var FontAwsomePickerView =
        '<div class="paFaPicker" ng-cloak> \
                <div class="faIcon fa" ng-class="fontAwsome.selector"></div> \
                <input class="faLabel" type="text" ng-model="fontAwsome.label" value="{{fontAwsome.selector}}" /> \
